        ...
        operation.queryCompletionBlock = { [unowned self] (cursor, error) in
            DispatchQueue.main.async {
                if error == nil {
                    ...
                    let ac = UIAlertController(title: "Fetch Failed", message: "There was a problem fetcthing the list of whistles; please try again: \(error!.localizedDescription)", preferredStyle: .alert)
